...
static float ambientLight[]  = {0.050, 0.050, 0.050, 0.001}; //was {0.50, 0.50, 0.50, 1.0};
static float diffuseLight[]  = {0.05, 0.05, 0.05, 0.001}; // was {1.00, 1.00, 1.00, 1.0
static float specularLight[] = {0.05, 0.05, 0.05, 0.001}; // was {1.00, 1.00, 1.00, 1.0}
float lightPosition[] = {100.0f, 150.0f, 100.0f, 0.005f}; // was 10.0f, 15.0f, 10.0f, 1.0f
...
void StrafeCamera(float delta_x, float delta_y)
{
    ...
    mPosition += strafe_rate * delta_y * mLookAt;
        ...
        case 'l':
		{
         ...
         case 't':
		 {
			 ...
			 if (gTriangleMeshes.size())
			 {
				 ...
				 /* Bring this back if something bad happens. Lol.
